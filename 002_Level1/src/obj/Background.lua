...
function Background:load()	
	--
	self.w = Game.assetManager:getImage("bgLevel"..tostring(Game.level)):getWidth()
	self.h = Game.assetManager:getImage("bgLevel"..tostring(Game.level)):getHeight()
	--	
	self:Scale()	
...
function Background:draw()
	--
	LG.draw(Game.assetManager:getImage("bgLevel"..tostring(Game.level)), 
