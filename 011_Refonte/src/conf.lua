function love.conf(t)
    ...
    t.window.title = "Atomix GDC v1.0"      -- The window title (string)
    
	--t.window.width  = 1280              	-- The window width (number)
    --t.window.height = 832	              	-- The window height (number)
	...
	t.identity = "Atomix"	            	-- The name of the save directory (string)
