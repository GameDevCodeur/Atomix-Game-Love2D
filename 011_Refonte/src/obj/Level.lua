...
function Level:init()
	...
	--	
	if Game.level >=  7 then Game.stage = 2 end
	if Game.level >= 13 then Game.stage = 3 end
	if Game.level >= 19 then Game.stage = 4 end
	if Game.level >= 25 then Game.stage = 5 end
	--
end
--
function Level:next()
